...
6. **`enrollmentRatios`** - podatki, o vključenosti prebivalcev v izobrazbo držav:
  ...
  **_Opomba_**: vidimo, da se v tabeli `enrollmentRatios` pri nekaterih državah procent vključenih v stopnjo izobrazbe presega 100%. Razlog za to je, da številka vključuje vse, ki obiskujejo določeno stopnjo izobrazbe, ne le tistih, ki bi jo zakonsko morali (npr. ponavljalci)
